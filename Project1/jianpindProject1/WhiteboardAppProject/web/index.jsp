...
<script>
    /* Every time you refresh the page, an empty item is automatically added */
    addToCart("")
</script>
<body>
<div style="float: left; width: 500px">
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <button id="removeButton" onclick="removeFromCart('<%= item.getCode() %>')">Remove from Cart</button>
            </td>
        </tr>
        <% } %> <!--for loop end-->
